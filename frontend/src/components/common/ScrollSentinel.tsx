...
export const ScrollSentinel: React.FC<ScrollSentinelProps> = ({
  ...
  return (
    <div
      ref={sentinelRef}
      className={`py-4 px-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#8e8e9f] border-t border-white/[0.06] bg-[#141418]/60 backdrop-blur-md rounded-b-[20px] ${className}`}
    >
      ...
      <div className="flex items-center gap-2">
        {loadingMore ? (
          <div className="flex items-center gap-2 text-primary font-medium py-1 px-3 bg-primary/10 rounded-full border border-primary/20 animate-pulse">
