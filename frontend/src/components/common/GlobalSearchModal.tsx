...
export const GlobalSearchModal: React.FC<GlobalSearchModalProps> = ({
  ...
  const allItems: SearchItem[] = useMemo(() => [
    ...
    // 2. Modules & Quick Actions Category
    {
      ...
      icon: PlusCircle,
      path: '/invoices',
      keywords: ['create invoice', 'new bill', 'gst invoice', 'sales invoice', 'vendor bill'],
      badge: 'Action',
      shortcut: '⌘I',
    },
    {
      ...
      icon: PlusCircle,
      path: '/sales-orders',
      keywords: ['create so', 'new sales order', 'book order', 'chairs', 'tables'],
      badge: 'Action',
    },
    {
      id: 'module-new-po',
      ...
      icon: ShoppingBag,
      path: '/purchase-orders',
      keywords: ['create po', 'purchase order', 'procurement', 'azure furniture'],
      badge: 'Action',
    },
    {
      ...
      icon: Package,
      path: '/products',
      keywords: ['add product', 'new sku', 'chair', 'table', 'sofa', 'goods', 'service'],
      badge: 'Action',
    },
    {
      id: 'module-report-bs',
      ...
      icon: FileSpreadsheet,
      path: '/reports',
      keywords: ['balance sheet', 'assets', 'liabilities', 'capital', 'financial report'],
      badge: 'Report',
    },
    {
      ...
      icon: FileSpreadsheet,
      path: '/reports',
      keywords: ['profit and loss', 'pnl', 'net profit', 'sales income', 'purchase expense'],
      badge: 'Report',
    },
