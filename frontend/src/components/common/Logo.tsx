  ...
  return (
    <div className={`flex items-center gap-3 select-none ${className}`} {...props}>
      ...
      <div className="relative w-9 h-9 shrink-0 flex items-center justify-center">
        ...
        <div className="absolute inset-[3px] rounded-full bg-background dark:bg-[#121216] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-1 rounded-full bg-card/60 dark:bg-[#18181f]/40 backdrop-blur-xs" />
        </div>
      </div>
      {!iconOnly && (
        <div className="flex flex-col text-left">
          <span className="font-bold text-base sm:text-lg leading-tight tracking-tight font-sans text-foreground dark:text-white">
            Urban Furniture
          </span>
          <span className="text-[10px] font-medium tracking-wider text-muted-foreground dark:text-[#9090a0] uppercase leading-none mt-0.5">
            Accounting System
          </span>
        </div>
      )}
